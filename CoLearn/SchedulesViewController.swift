...
class SchedulesViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func createSchedules(){
        ...
        let s = Schedule(user_id: "1265123510169659", instructor_id: "123042818089530", lang: Languages.LangType.FRENCH, time: NSDate(), timezone: NSTimeZone.localTimeZone(), requestNote: "Visit to France soon. It would be of great help to me if spare some time", responseNote: "", scheduleStatus: ScheduleStatus.status.PENDING)
